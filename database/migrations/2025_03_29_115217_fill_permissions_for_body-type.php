...
class FillPermissionsForBodyType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBodyType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.body-type',
            'admin.body-type.index',
            'admin.body-type.create',
            'admin.body-type.show',
            'admin.body-type.edit',
            'admin.body-type.delete',
            'admin.body-type.bulk-delete',
        ]);
