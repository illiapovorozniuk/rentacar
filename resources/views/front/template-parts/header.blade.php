...
{{--                    @if($menu->menu_page == 'goodfor_yachts' && $goodfors !== null)--}}
{{--                        <div class="brand_item">--}}
{{--                            <p class="brand_list">{{ ucfirst($menu->name) }}--}}
{{--                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"--}}
{{--                                     xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                            <div class="brand_items">--}}
{{--                                <ul class="brand_items_tag">--}}
{{--                                    @foreach($goodfors as $i=>$item)--}}
{{--                                        <li>--}}
{{--                                            <a href="{{baseUrl().'/'.Config::get('services.goodfor_link').'/'.$item['link']}}">{{ucfirst($item['name'])}}</a>--}}
{{--                                        </li>--}}
{{--                                    @endforeach--}}
{{--                                </ul>--}}
{{--                            </div>--}}
...
{{--                    @if($menu->menu_page == 'types_yachts' && $types_yachts !== null)--}}
{{--                        <div class="brand_item">--}}
{{--                            <p class="brand_list bold">{{ ucfirst($menu->name) }}--}}
{{--                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"--}}
{{--                                     xmlns="http://www.w3.org/2000/svg">--}}
{{--                                    <path--}}
{{--                                        d="M14.6666 7.64166C14.5104 7.48646 14.2992 7.39934 14.0791 7.39934C13.8589 7.39934 13.6477 7.48646 13.4916 7.64166L10.4999 10.5917L7.54992 7.64166C7.39378 7.48646 7.18257 7.39934 6.96242 7.39934C6.74226 7.39934 6.53105 7.48646 6.37492 7.64166C6.29681 7.71913 6.23481 7.8113 6.19251 7.91285C6.1502 8.0144 6.12842 8.12332 6.12842 8.23333C6.12842 8.34334 6.1502 8.45226 6.19251 8.55381C6.23481 8.65536 6.29681 8.74753 6.37492 8.825L9.90825 12.3583C9.98572 12.4364 10.0779 12.4984 10.1794 12.5407C10.281 12.583 10.3899 12.6048 10.4999 12.6048C10.6099 12.6048 10.7188 12.583 10.8204 12.5407C10.9219 12.4984 11.0141 12.4364 11.0916 12.3583L14.6666 8.825C14.7447 8.74753 14.8067 8.65536 14.849 8.55381C14.8913 8.45226 14.9131 8.34334 14.9131 8.23333C14.9131 8.12332 14.8913 8.0144 14.849 7.91285C14.8067 7.8113 14.7447 7.71913 14.6666 7.64166Z"--}}
...
{{--                            <div class="brand_items">--}}
{{--                                <ul class="brand_items_tag">--}}
{{--                                    @foreach($types_yachts as $i=>$item)--}}
{{--                                        <li>--}}
{{--                                            <a href="{{baseUrl().'/'.Config::get('services.types_yacht_link').'/'.$item['link']}}">{{ucfirst($item['name'])}}</a>--}}
...
{{--                    @if($menu->menu_page == 'marinas_yachts' && $marinas !== null)--}}
{{--                        <div class="brand_item">--}}
{{--                            <p class="brand_list">{{ ucfirst($menu->name) }}--}}
{{--                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none"--}}
{{--                                     xmlns="http://www.w3.org/2000/svg">--}}
...
{{--                            <div class="brand_items">--}}
{{--                                <ul class="brand_items_tag">--}}
{{--                                    @foreach($marinas as $i=>$item)--}}
{{--                                        <li>--}}
{{--                                            <a href="{{baseUrl().'/'.Config::get('services.marinas_link').'/'.$item['link']}}">{{ucfirst($item['name'])}}</a>--}}
...
{{--                @endif--}}
{{--                @if($menu->link == Config::get('services.brands_link'))--}}
{{--                    @if(count($brands) > 1)--}}
{{--                        @if($menu->menu_type == 0)--}}
{{--                            <a href="{{ baseUrl() }}/{{ Config::get('services.brands_link') }}"--}}
{{--                               class="nav-link">{{ $menu->name }}</a>--}}
...
{{--                                            @if($brand != null)--}}
{{--                                                    <?php $brands_output .= '<li><a href="' . baseUrl() . '/' . $site->cars_brands_slug . '/' . $brand['link'] . '">  <img src="' . photo_url("brand", $brand['brand_slug'] . ".webp") . '" alt="' . $brand['name'] . '" loading="lazy" width="35px" height="35px"><span>' . $brand['name'] . '</span> <span class="cars_count">' . $brand['count'] . '</span></a></li>'; ?>--}}
{{--                                            @endif--}}
{{--                                        @endforeach--}}
{{--                                        {!! $brands_output !!}--}}
...
{{--            @endforeach--}}
            ...
            <nav class="param">
                <div class="params_header">
                    ...
                    <span class="title">{{trans('trans_renty.front.languages_currencies')}}</span>
